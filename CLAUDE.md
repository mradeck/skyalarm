...
**Aktuell:** v0.27 — Bugfix Popup-Persistenz: Cleanup-Flag verhindert, dass `clearLayers()` den gemerkten Hex synchron zerstört, bevor der neue Marker das Popup wieder öffnen kann
